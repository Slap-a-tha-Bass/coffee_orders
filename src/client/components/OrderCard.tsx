...
const OrderCard = (props: OrderCardProps) => {
    ...
    // BELOW CODE: Triggered a second rendering of the state that's already being called via ReviewOrder
    ...
    return (
        <div className="card col-md-6 p-0 mt-2">
            <div className="card-header bg-dark display-4 text-light">{props.first_name}</div>
            <div className="card-body">
                <h2 className="card-title">{props.drink_type} + {props.food_type}</h2>
